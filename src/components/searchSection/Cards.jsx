...
function Cards({
  ...
  return (
    <div className="flex py-6 px-5 rounded-xl justify-between  border-2 xs:block md:flex">
      <div className="h-[20vh] flex items-center gap-4">
        <div className="">
          <img src={img} className="w-32 xs:w-28 lg:w-32" alt="laptop image" />
        </div>
        <div>
          <h2 className="text-[1.4rem] font-semibold xs:text-lg lg:text-[1.4rem]">{postName}</h2>
      ...
      <div className="flex flex-col justify-between xs:justify-end xs:text-xs md:justify-between lg:text-base">
        ...
        <p className="flex items-center gap-1 text-[#94748B] font-medium"/* md:text-sm"*/>
          <span>
            <MdOutlineAccessTime />
          </span>
          {jobPostTime}
